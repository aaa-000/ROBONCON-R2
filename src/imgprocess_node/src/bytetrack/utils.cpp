...
/**
 * @brief 将已追踪轨迹和失追轨迹合并为初步跟踪
 * @return 返回初步跟踪轨迹的指针容器
*/
...
/**
 * @brief 线性分配,好像是匈牙利算法,还没细看
 * @param 输入为iou矩阵,轨迹数,检测数,iou阈值,匹配对容器,未被匹配的轨迹,未被匹配的检测
 * @return 应该是对匹配对容器,未被匹配的轨迹,未被匹配的检测做引用改变
*/
...
/**
 * @brief 计算iou,即经卡尔曼预测的矩形框和待匹配的检测矩形框的交集面积除并集面积
 * @param atracks为轨迹,btracks为待匹配检测,dist_size和dist_size_size分别为轨迹数和检测数
 * @return 返回储存iou的容器
*/
...
/**
 * @brief 计算iou,即经卡尔曼预测的矩形框和待匹配的检测矩形框的交集面积除并集面积(与上个函数只有输入容器为类对象的区别)
 * @param atracks为轨迹,btracks为待匹配检测,dist_size和dist_size_size分别为轨迹数和检测数
 * @return 返回储存iou的容器
*/
